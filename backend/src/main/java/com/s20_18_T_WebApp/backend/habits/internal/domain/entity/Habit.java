...
public abstract class Habit extends BaseEntity { //TODO ALMACENAR LAS METAS A ALCANZAR PARA CADA HABITO(EJ ACTIVICAD FISICA CORRER 2KM POR DIA) y tipo de unidad en un string.
    ...
    public Habit(String name, HabitType type, Set<DayOfWeek> dayOfWeeks, LocalDate endDate) {
    }
    ...
    public void setScheduleDays(Set<DayOfWeek> scheduleDays) {
    ...
    public void setProgress(List<DailyProgress> progress) {
